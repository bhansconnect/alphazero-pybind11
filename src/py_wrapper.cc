...
PYBIND11_MODULE(alphazero, m) {
  ...
  py::class_<TakGS<4>, GameState>(m, "TakGS4")
      ...
      .def("ptn_to_move_index", &TakGS<4>::ptn_to_move_index)
      .def("move_index_to_ptn", &TakGS<4>::move_index_to_ptn)
      .def("check_road_win", &TakGS<4>::check_road_win)
      .def("count_flats", &TakGS<4>::count_flats)
  ...
  py::class_<TakGS<5>, GameState>(m, "TakGS5")
      ...
      .def("ptn_to_move_index", &TakGS<5>::ptn_to_move_index)
      .def("move_index_to_ptn", &TakGS<5>::move_index_to_ptn)
      .def("check_road_win", &TakGS<5>::check_road_win)
      .def("count_flats", &TakGS<5>::count_flats)
      .def_static("NUM_PLAYERS", [] { return tak_gs::NUM_PLAYERS; })
  ...
  py::class_<TakGS<6>, GameState>(m, "TakGS6")
      ...
      .def("ptn_to_move_index", &TakGS<6>::ptn_to_move_index)
      .def("move_index_to_ptn", &TakGS<6>::move_index_to_ptn)
      .def("check_road_win", &TakGS<6>::check_road_win)
      .def("count_flats", &TakGS<6>::count_flats)
      .def_static("NUM_PLAYERS", [] { return tak_gs::NUM_PLAYERS; })
