...
Emits bench/results/<tag>.json (gitignored — local only, never commit) and prints
a summary.
...
def main():
    ...
    ap.add_argument("--tag", default="local", help="results filename tag (default: local)")
    ...
    env = env_info()
    print("=" * 70)
    print(f"MACHINE BENCHMARK — {args.tag}")
    print("=" * 70)
